////////////////////////////////////////////////
// Jpwaters09.github.io Projects Page         //
// Language: JavaScript                       //
// Author: Jacob Waters                       //
...
document.addEventListener("DOMContentLoaded", function () {
    if (localStorage.getItem("Theme") == "0") {
        ...
        document.getElementById("activeBuzzer").style.backgroundColor = "#292929";
        document.getElementById("raspberryPiProjectsList").style.backgroundColor = "#292929";
        ...
        document.getElementById("raspberryPiProjectsTitle").style.color = "#ffffff";
        document.getElementById("activeBuzzerTitle").style.color = "#ffffff";
        ...
        setTimeout(() => {
            ...
            document.getElementById("raspberryPiProjectsList").classList.add("transition");
            document.getElementById("raspberryPiProjectsTitle").classList.add("transition");
            document.getElementById("activeBuzzer").classList.add("transition");
            document.getElementById("activeBuzzerTitle").classList.add("transition");
        }, 300);
        ...
        document.getElementById("activeBuzzer").style.backgroundColor = "#d9d9d9";
        document.getElementById("raspberryPiProjectsList").style.backgroundColor = "#d9d9d9";
        ...
        document.getElementById("raspberryPiProjectsTitle").style.color = "#000000";
        document.getElementById("activeBuzzerTitle").style.color = "#000000";
    ...
    document.getElementById("activeBuzzer").addEventListener("mouseenter", () => {
        if (theme == 0) {
            document.getElementById("activeBuzzer").style.backgroundColor = "#393939";
        }
        
        else if (theme == 1) {
            document.getElementById("activeBuzzer").style.backgroundColor = "#c9c9c9";
        }
    });

    document.getElementById("activeBuzzer").addEventListener("mouseleave", () => {
        if (theme == 0) {
            document.getElementById("activeBuzzer").style.backgroundColor = "#292929";
        }
